  ...
  return (
    <div className="w-full lgl:w-2/5 flex justify-center items-center relative py-6">
      ...
      <div className="relative group max-w-sm sm:max-w-md w-full flex justify-center">
        {/* Frame backdrop */}
        <div className="relative rounded-3xl p-3 bg-gradient-to-b from-sky-500/20 via-slate-200/50 to-transparent dark:from-sky-500/30 dark:via-slate-800/60 dark:to-transparent border border-slate-200/80 dark:border-slate-700/60 shadow-xl overflow-hidden">
          <img
            className="w-full h-auto max-h-[460px] sm:max-h-[500px] object-cover rounded-2xl transition-transform duration-500 group-hover:scale-[1.02]"
            src={bannerImg}
        ...
        <div className="absolute -top-3 -right-2 sm:-right-4 px-3.5 py-2 rounded-xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-slate-200 dark:border-slate-700 shadow-lg flex items-center gap-2 animate-bounce-subtle">
          ...
          <div>
            <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium leading-none">Specialization</p>
            <p className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">React & Next.js</p>
          </div>
        </div>
        ...
        <div className="absolute -bottom-3 -left-2 sm:-left-4 px-3.5 py-2 rounded-xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-slate-200 dark:border-slate-700 shadow-lg flex items-center gap-2">
          ...
          <div>
            <p className="text-[10px] text-slate-500 dark:text-slate-400 font-medium leading-none">Cross-Platform</p>
            <p className="text-xs font-bold text-slate-900 dark:text-white mt-0.5">React Native</p>
          </div>
        </div>
      </div>
    </div>
